...
c2.execute("""SELECT ville_longitude_deg, ville_latitude_deg, ville_population_2012 FROM villes_france_free WHERE LENGTH(ville_departement)=2 """)
tab=c2.fetchall()
